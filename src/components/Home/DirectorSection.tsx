        ...
        <div className="flex flex-col md:flex-row items-center max-w-5xl mx-auto bg-white rounded-lg shadow px-2 md:px-6 py-6">
            ...
            <div>
                ...
                <p className="text-gray-700 mb-2 text-sm">
                    ...
                    He also serves as reviewer and PC member in top journals and conferences, including Nature Machine Intelligence, npj Digital Medicine, Nature Scientific Report, IEEE Transactions on Mobile Computing, IEEE Intelligent Systems, ICCAD, ICCD, NeurIPS, ICLR, AAAI, and AISTATS.
